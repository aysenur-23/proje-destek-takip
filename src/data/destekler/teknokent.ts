...
export const teknokentDestekleri: DestekProgrami[] = [
  ...
  {
    slug: "teknokent-spin-off",
    ad: "Teknokent Spin-Off Şirket Kurulum Desteği",
    kurum: "Teknokent Yönetici Şirketleri",
    kategori: "TEKNOKENT",
    tur: "HIBE",
    aciklama:
      "Üniversite Ar-Ge projelerinden doğan spin-off şirketlerin kuruluş ve ön ticari faaliyetlerine ofis, mentörlük ve hibe desteği.",
    amac: "Üniversite kökenli girişimciliği teşvik etmek.",
    butceUstSinir: 500000,
    hibeOrani: 100,
    aktif: true,
    mevzuatUrl: "https://www.sanayi.gov.tr/hizmetler/ar-ge-ve-teknoloji/teknoloji-gelistirme-bolgeleri",
    etiketler: ["spin-off", "teknokent", "startup", "üniversite", "girişimcilik"],
    oncelik: 2,
    sonGuncelleme: "2026-05-10",
    kriterler: {
      teknokentZorunlu: true,
      ...
      notlar: "Üniversite menşeli Ar-Ge projesinden türeyen firma ya da doktora mezunu girişimci.",
    },
  },
  {
    slug: "teknokent-nitelikli-fon",
    ad: "Teknokent Melek Yatırım ve Nitelikli Yatırımcı Eşleştirme",
    kurum: "Teknokent Yönetici Şirketleri / TTO",
    kategori: "TEKNOKENT",
    tur: "KARMA",
    aciklama:
      "Teknokent girişimlerini melek yatırımcılar ve risk sermayesi fonlarıyla buluşturan yapılandırılmış program.",
    amac: "Erken aşama teknoloji girişimlerinin özel finansmana erişimini sağlamak.",
    aktif: true,
    mevzuatUrl: "https://www.sanayi.gov.tr/hizmetler/ar-ge-ve-teknoloji/teknoloji-gelistirme-bolgeleri",
    etiketler: ["melek yatırım", "risk sermayesi", "startup", "teknokent", "fon"],
    oncelik: 3,
    sonGuncelleme: "2026-05-10",
    kriterler: {
      teknokentZorunlu: true,
      argeZorunlu: true,
      notlar: "Teknoloji transfer ofisi (TTO) aracılığıyla eşleştirme yapılır.",
    },
  },
];
